        ...
        <Stack spacing={2}>
          <Box>
            ...
            <label htmlFor="upload-image">
              <Box sx={{ border: "2px dashed #D32F2F", borderRadius: 2, textAlign: "center", p: 2, cursor: "pointer", maxHeight:'18rem' }}>
                {imagePreview ? <img src={imagePreview} alt="Preview" style={{ width: "100%", height : '100%', borderRadius: 8, objectFit: "cover" }} /> : 
          ...
          <Box display="flex" justifyContent="flex-end">
            <Button sx={{ bgcolor: "#D32F2F", color: "#FFFFFF", borderRadius: 1, padding: "10px 20px", "&:hover": { bgcolor: "#B71C1C" } }} onClick={handleCreateCategory}>Yaratish</Button>
          </Box>
        </Stack>
      </Paper>
    </Box>
